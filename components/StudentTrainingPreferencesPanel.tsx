      ...
      <div className="space-y-4 rounded-2xl border border-[#ffffff10] bg-[#111] p-5">
        <div className="grid grid-cols-2 gap-3 md:grid-cols-5">
          ...
          <button
            ...
            className="rounded-xl bg-[#1a1a1a] p-4 text-left hover:ring-1 hover:ring-[#D4A373]/40"
          >
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-[1fr_220px_auto]">
          <input
            ...
            className="w-full rounded-xl border border-[#ffffff10] bg-[#1a1a1a] px-4 py-3 text-sm text-[#f5f5f5] outline-none placeholder:text-[#6b6b6b] focus:border-[#D4A373]"
          />

          <select
            value={filter}
            onChange={(event) => setFilter(event.target.value as FilterMode)}
            className="w-full rounded-xl border border-[#ffffff10] bg-[#1a1a1a] px-4 py-3 text-sm text-[#f5f5f5] outline-none focus:border-[#D4A373]"
          >
        ...
        <div className="rounded-xl border border-[#D4A373]/20 bg-[#D4A373]/10 p-4">
          <p className="mb-1 text-xs font-semibold text-[#D4A373]">Como usar</p>
              ...
              >
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  <div className="flex min-w-0 gap-3">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-[#D4A373]/30 bg-[#1a1a1a]">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {permissions.role === "TEACHER" && (
                      <Link
                        ...
                        className="rounded-lg bg-[#D4A373] px-3 py-2 text-xs font-semibold text-[#0a0a0a] hover:bg-[#c49563]"
                      >
                ...
                <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
                  <div className="rounded-xl border border-[#ffffff10] bg-[#0a0a0a] p-4">
                    <p className="mb-2 text-xs font-semibold text-[#D4A373]">Preferência estruturada</p>
                  ...
                  <div className="rounded-xl border border-[#ffffff10] bg-[#0a0a0a] p-4">
                    <p className="mb-2 text-xs font-semibold text-[#D4A373]">Relato original do aluno</p>
                    <p className="whitespace-pre-wrap text-sm leading-relaxed text-[#e5e5e5]">
