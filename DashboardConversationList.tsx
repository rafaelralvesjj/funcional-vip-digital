...
function hasChatAttachment(item: { imageUrl?: string | null; videoUrl?: string | null; documentUrl?: string | null; attachments?: ConversationAttachment[] }): boolean {
  return Boolean(item.imageUrl || item.videoUrl || item.documentUrl || item.attachments?.length);
}

function renderAttachmentIndicator(item: { imageUrl?: string | null; videoUrl?: string | null; documentUrl?: string | null; documentName?: string | null; attachments?: ConversationAttachment[] }) {
