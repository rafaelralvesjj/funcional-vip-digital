  ...
  try {
    ...
    return NextResponse.json({
      ...
      latestWorkout: workouts[0]
        ? {
            id: workouts[0].id,
            date: workouts[0].date.toISOString(),
            status: workouts[0].status,
            notes: workouts[0].notes || null,
            plan: workouts[0].workoutPlan
              ? {
                  id: workouts[0].workoutPlan.id,
                  name: workouts[0].workoutPlan.name,
                  date: workouts[0].workoutPlan.date?.toISOString?.() || null,
                }
              : null,
          }
        : null,
