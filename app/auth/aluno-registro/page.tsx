          ...
          <section className="space-y-4 border-t border-[#ffffff10] pt-5">
            ...
            <div className="rounded-xl border border-[#ffffff10] bg-[#0d0d0d] p-4">
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-xl border p-4 text-left transition ${
                        selected
                          ? "border-[#D4A373] bg-[#D4A373]/10 shadow-[0_0_0_1px_rgba(212,163,115,0.15)]"
                          : "border-[#ffffff10] bg-[#151515] hover:border-[#D4A373]/40"
                      }`}
                    >
                      <div className="flex items-center justify-between gap-3">
                        <span className={selected ? "font-semibold text-[#D4A373]" : "font-semibold text-[#f5f5f5]"}>
                          {option.label}
                        </span>
                        <span
                          className={`flex h-5 w-5 items-center justify-center rounded-full border text-[11px] ${
                            selected
                              ? "border-[#D4A373] bg-[#D4A373] text-[#0a0a0a]"
              ...
              {form.trainingLocations.includes("ACADEMIA") && (
                <div className="mt-4 rounded-xl border border-[#D4A373]/20 bg-[#D4A373]/5 p-4">
                  <label className="block text-sm text-[#d6d6d6] mb-1">
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-3 rounded-lg border px-3 py-2.5 text-left text-xs transition ${
                            selected
                              ? "border-[#D4A373] bg-[#D4A373]/10 text-[#f5f5f5]"
                              : "border-[#ffffff10] bg-[#101010] text-[#bdbdbd] hover:border-[#D4A373]/35"
                          }`}
                        >
                          <span
