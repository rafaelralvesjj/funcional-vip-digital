      ...
      <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f5]">
        <div className="bg-gradient-to-b from-[#D4A373]/10 to-transparent pb-8">
          <div className="max-w-2xl mx-auto px-4 pt-12 text-center">
            <div className="w-20 h-20 bg-[#D4A373]/10 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="max-w-2xl mx-auto px-4 pb-16 -mt-4 space-y-4">
          {/* Score de evolução */}
          <div className="bg-gradient-to-r from-[#D4A373]/10 to-transparent border border-[#D4A373]/20 rounded-xl p-6 text-center">
            <span className="text-5xl">
              {relatorio.scoreEvolucao >= 80 ? "🔥" : relatorio.scoreEvolucao >= 50 ? "💪" : "📈"}
            </span>
            <h2 className="text-lg font-bold text-[#D4A373] mt-2">
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f5]">
      ...
      <div className="max-w-2xl mx-auto px-4 pb-16 -mt-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Medidas */}
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
            <h2 className="text-lg font-semibold text-[#D4A373] mb-4">📏 Atualize suas medidas</h2>
          ...
          {/* Foto */}
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
            <h2 className="text-lg font-semibold text-[#D4A373] mb-4">📸 Foto do mês</h2>
            ...
            />
            {uploading && <p className="text-xs text-[#D4A373] mt-2">Enviando foto...</p>}
