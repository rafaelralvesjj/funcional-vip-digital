      ...
      <div className="max-w-4xl mx-auto p-4 md:p-6 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5 space-y-4">
            <h2 className="text-lg font-semibold text-[#D4A373]">Informacoes do Treino</h2>
            <div>
          ...
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-[#D4A373]">Exercicios</h2>
              <button
                type="button"
            ...
            {showLibrary && (
              <div className="bg-[#0a0a0a] border border-[#ffffff10] rounded-lg p-4 mb-4">
                <input
                  ...
                  className="w-full rounded-lg border border-[#ffffff10] bg-[#111] px-4 py-2 text-sm text-[#f5f5f5] placeholder-[#6b6b6b] outline-none focus:border-[#D4A373] mb-3"
                />
                  ...
                  <div key={index} className="bg-[#0a0a0a] border border-[#ffffff10] rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      <div>
                        ...
                        <input type="number" value={ex.series} onChange={(e) => updateExercise(index, "series", Number(e.target.value))}
                          className="w-full rounded border border-[#ffffff10] bg-[#111] px-2 py-1.5 text-xs text-[#f5f5f5] outline-none focus:border-[#D4A373]" />
                      </div>
                      <div>
                    ...
                    <div className="mt-2">
                      ...
                      <input type="text" value={ex.notes} onChange={(e) => updateExercise(index, "notes", e.target.value)}
                        ...
                        className="w-full rounded border border-[#ffffff10] bg-[#111] px-2 py-1.5 text-xs text-[#f5f5f5] placeholder-[#6b6b6b] outline-none focus:border-[#D4A373]" />
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
            <h2 className="text-lg font-semibold text-[#D4A373] mb-4">Observacoes do Plano</h2>
            <textarea
              value={notes}
