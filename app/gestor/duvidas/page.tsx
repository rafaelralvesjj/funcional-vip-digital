...
export default function GestorDuvidasPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f5]">
      {/* Header */}
      <div className="bg-gradient-to-b from-[#00A19C]/10 to-transparent pb-6">
        <div className="max-w-4xl mx-auto px-4 pt-12">
          <div className="flex items-center justify-between mb-2">
            <button
              onClick={() => router.push("/dashboard")}
              className="text-sm text-[#00A19C] hover:text-[#007D79]"
            >
              ← Voltar ao Dashboard
            </button>
          </div>
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#00A19C]/10 rounded-full flex items-center justify-center">
                  ...
                  {!duvida.answer && (
                    <span className="text-xs bg-[#00A19C]/10 text-[#00A19C] px-3 py-1 rounded-full">
                      ⏳ Pendente
                    </span>
                  )}
                </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {duvida.videoUrl && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-xs bg-[#1a1a1a] text-[#00A19C] px-3 py-1.5 rounded-lg hover:bg-[#252525]"
                      >
                        ▶️ Ver vídeo
                      </a>
                    )}
                ...
                {duvida.answer && (
                  <div className="mt-3 pt-3 border-t border-[#ffffff10]">
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 bg-[#00A19C]/20 rounded-full flex items-center justify-center flex-shrink-0">
                        <span className="text-sm">👨‍🏫</span>
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-sm font-medium text-[#00A19C]">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="bg-[#00A19C] text-[#0a0a0a] font-bold px-4 py-2 rounded-lg text-sm transition hover:bg-[#007D79] disabled:opacity-70"
                          >
