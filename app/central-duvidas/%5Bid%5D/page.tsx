      ...
      <div className="max-w-2xl mx-auto px-4 pb-16 -mt-4 space-y-4">
        ...
        {mostrarForm && (
          <form onSubmit={handleSubmit} className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5 space-y-4">
            <h2 className="font-semibold text-[#00A19C]">Nova Dúvida</h2>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-[#00A19C] text-[#0a0a0a] font-bold rounded-xl py-3 text-sm transition hover:bg-[#007D79] disabled:opacity-70"
              >
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {duvida.videoUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-xs bg-[#1a1a1a] text-[#00A19C] px-3 py-1.5 rounded-lg hover:bg-[#252525] transition"
                  >
                    ▶️ Ver vídeo
                  </a>
                )}
