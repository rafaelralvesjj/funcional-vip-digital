...
export default function OnboardingPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f5]">
      {/* Header */}
      <div className="bg-gradient-to-b from-[#00A19C]/10 to-transparent pb-12">
      ...
      <div className="max-w-2xl mx-auto px-4 pb-16 -mt-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
            <h2 className="text-lg font-semibold text-[#00A19C] mb-4">🎯 Seu Objetivo</h2>
                      ...
                      <label
                        ...
                        className={`flex items-center gap-2 p-2.5 rounded-lg border text-sm cursor-pointer transition ${
                          form.equipamentos.includes(eq.value)
                            ? "bg-[#00A19C]/10 border-[#00A19C] text-[#f5f5f5]"
                            : "bg-[#0a0a0a] border-[#ffffff10] text-[#a1a1a1] hover:border-[#00A19C]/50"
                        }`}
                      >
                        <input
                          type="checkbox"
          ...
          {/* Seção: Dados Físicos */}
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
            <h2 className="text-lg font-semibold text-[#00A19C] mb-4">📏 Dados Físicos</h2>
          ...
          {/* Seção: Contexto */}
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
            <h2 className="text-lg font-semibold text-[#00A19C] mb-4">📋 Seu Contexto</h2>
            <div className="space-y-4">
              <div>
                <label className="text-sm text-[#e5e5e5] block mb-1">
                  Nível de atividade
          ...
          {/* Seção: Foto */}
          <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
            <h2 className="text-lg font-semibold text-[#00A19C] mb-4">📸 Foto Inicial</h2>
            ...
            />
            {uploading && (
              <p className="text-xs text-[#00A19C] mt-2">Enviando foto...</p>
            )}
