    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f5] p-6">
      <div className="max-w-5xl mx-auto">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-[#00A19C] mb-2">Gestão</h1>
        ...
        <div className="flex gap-4 mb-8 border-b border-[#ffffff10]">
          <button
            ...
            className={`pb-2 px-4 transition-colors ${activeTab === "mural" ? "border-b-2 border-[#00A19C] text-[#00A19C]" : "text-[#a1a1a1] hover:text-[#f5f5f5]"}`}
          >
            Mural
          </button>
          <button
            onClick={() => setActiveTab("chat")}
            className={`pb-2 px-4 transition-colors ${activeTab === "chat" ? "border-b-2 border-[#00A19C] text-[#00A19C]" : "text-[#a1a1a1] hover:text-[#f5f5f5]"}`}
          >
            Chat
          </button>
        </div>
              ...
              <form onSubmit={handlePublishNotice} className="bg-[#111111] border border-[#ffffff10] p-6 rounded-xl space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#0a0a0a] border border-[#ffffff10] rounded-lg p-2 text-sm focus:outline-none focus:border-[#00A19C]"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#0a0a0a] border border-[#ffffff10] rounded-lg p-2 text-sm focus:outline-none focus:border-[#00A19C] h-32 resize-none"
                ...
                notices.map(n => (
                  <div key={n.id} className="bg-[#111111] border border-[#ffffff10] p-4 rounded-xl">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="font-bold text-[#00A19C]">{n.title}</h3>
                    ...
                    <div className="space-y-2">
                      <div className="flex flex-wrap gap-2">
                        ...
                        {getNoticeTargetNames(n).length === 0 ? (
                          <span className="text-[10px] bg-[#00A19C]/10 text-[#00A19C] px-2 py-0.5 rounded">
                        ...
                        {q.resolvedAt ? (
                          ...
                          <div className="pt-2 space-y-2">
                            <textarea
                              ...
                              className="w-full bg-[#111111] border border-[#ffffff10] rounded-lg p-2 text-xs focus:outline-none focus:border-[#00A19C] h-20 resize-none"
                            ...
                            <div className="flex flex-wrap gap-2">
                              <button
                                ...
                                className="bg-[#00A19C] text-black text-xs font-bold px-4 py-1.5 rounded hover:bg-[#007D79] transition-colors"
                              >
                                Responder
                              </button>
