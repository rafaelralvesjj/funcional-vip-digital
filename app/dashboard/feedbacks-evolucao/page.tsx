    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <button
          ...
          className="bg-[#111] border border-[#ffffff10] rounded-xl p-4 text-left hover:border-[#D4A373]/40 transition"
        >
          <p className="text-xs text-[#a1a1a1]">Para revisar</p>
          <p className="text-2xl font-bold text-[#D4A373]">{counters.ready}</p>
        </button>
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-4">
                <div>
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] px-2 py-1 rounded-full bg-[#D4A373]/10 text-[#D4A373] border border-[#D4A373]/20">
              ...
              {feedback.status === "AGUARDANDO_BIOIMPEDANCIA" ? (
                ...
                <div className="space-y-3">
                  <textarea
                    ...
                    className="w-full min-h-[260px] bg-[#1a1a1a] border border-[#ffffff10] rounded-xl px-4 py-3 text-sm text-[#f5f5f5] outline-none focus:border-[#D4A373] disabled:opacity-70"
                  />
                  ...
                  {feedback.status !== "ENVIADO" && (
                    <div className="flex flex-col md:flex-row gap-2 md:justify-end">
                      <button
                        ...
                        className="px-4 py-2 rounded-lg border border-[#ffffff15] text-[#a1a1a1] text-sm hover:text-white hover:border-[#D4A373]/40 transition disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-lg bg-[#D4A373] text-[#0a0a0a] font-semibold text-sm hover:bg-[#c49563] transition disabled:opacity-50"
                      >
