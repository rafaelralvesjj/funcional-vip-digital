...
export default function StudentDetailPage() {
  ...
  function getQuestionBubbleClass(item: AnyItem): string {
    ...
    return "border-[#00A19C]/20 bg-[#00A19C]/5";
  }
  ...
  function getQuestionBadgeClass(item: AnyItem): string {
    ...
    return "bg-[#00A19C]/15 text-[#00A19C]";
  }
      ...
      >
        ...
        >
          <div className="flex items-start justify-between gap-4 border-b border-[#ffffff10] p-4">
            <div>
              <p className="text-[10px] uppercase tracking-[0.24em] text-[#00A19C] font-semibold">
                Conversa da dúvida
              </p>
            ...
            {messages.map((item, index) => (
              <div key={item.id || index} className="space-y-3">
                ...
                {shouldShowLegacyAnswer(item) && (
                  <div className="ml-0 md:ml-8 rounded-2xl border border-[#00A19C]/20 bg-[#00A19C]/5 p-4">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="text-sm font-semibold text-[#f5f5f5]">
                          {item?.answeredBy?.name || professorName || "Professor"}
                        </span>
                        <span className="rounded-full bg-[#00A19C]/15 px-2 py-1 text-[10px] font-semibold text-[#00A19C]">
                          Resposta
                        </span>
                      </div>
          ...
          return (
            <div
              ...
              className={
                ...
                (kind === "question" ? "cursor-pointer hover:border-[#00A19C]/40 hover:bg-[#141414] transition" : "")
              }
            >
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3">
                <div>
                  ...
                  {kind === "question" && (
                    <p className="text-xs text-[#00A19C] mt-2 font-semibold">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="h-20 w-20 shrink-0 overflow-hidden rounded-full border border-[#00A19C]/30 bg-[#111] flex items-center justify-center">
              {studentImageUrl ? (
                <img
                  src={studentImageUrl}
                ...
                <span className="text-2xl font-bold text-[#00A19C]">
            ...
            <div>
              <Link href="/dashboard/students" className="text-xs text-[#00A19C] underline">
                ← Voltar para alunos
              </Link>

              <p className="text-xs uppercase tracking-[0.3em] text-[#00A19C] mt-4 mb-2">
                Ficha do aluno
              </p>
              ...
              <p className={"text-xs mt-1 font-semibold " + (student?.ageYears === null || student?.ageYears === undefined ? "text-red-400" : "text-[#00A19C]")}>
          ...
          <>
            <section className="bg-[#111] border border-[#ffffff10] rounded-2xl p-4 md:p-5 space-y-4">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.24em] text-[#00A19C] font-semibold">
                ...
                {student?.ageYears === null || student?.ageYears === undefined ? (
                  <span
                    className="inline-flex cursor-not-allowed items-center justify-center rounded-xl bg-[#00A19C]/30 text-[#6b6b6b] px-4 py-3 text-xs font-semibold"
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center rounded-xl bg-[#00A19C] text-[#0a0a0a] px-4 py-3 text-xs font-semibold hover:bg-[#008B87] transition"
                  >
                    Gerar resumo IA
                  </Link>
                )}
            ...
            <section className="grid grid-cols-1 md:grid-cols-4 gap-3">
              <div className="bg-[#111] border border-[#ffffff10] rounded-2xl p-4">
                ...
                <p className="text-lg font-bold text-[#00A19C] mt-1">
            ...
            <section className="bg-[#111] border border-[#ffffff10] rounded-2xl p-4 md:p-5 space-y-4">
              ...
              {activeTab === "resumo" && (
                <div id="student-summary-print" className="rounded-2xl border border-[#ffffff10] bg-[#0f0f0f] p-5 space-y-5">
                  <div>
                    <h2 className="text-lg font-semibold text-[#00A19C]">Resumo do aluno</h2>
                  ...
                  <section className="space-y-3">
                    <h3 className="text-sm font-semibold text-[#00A19C]">1. Identificação e contrato</h3>
                  ...
                  <section className="space-y-3">
                    <h3 className="text-sm font-semibold text-[#00A19C]">2. Ficha inicial / onboarding</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <section className="space-y-3">
                    <h3 className="text-sm font-semibold text-[#00A19C]">3. Histórico visível</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  {notices.length > 0 && (
                    <section className="space-y-3">
                      <h3 className="text-sm font-semibold text-[#00A19C]">4. Avisos recentes — resumo</h3>
                  ...
                  <section className="space-y-3">
                    <h3 className="text-sm font-semibold text-[#00A19C]">5. Leitura operacional para o professor</h3>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button
                      ...
                      className="rounded-xl bg-[#00A19C] text-[#0a0a0a] px-4 py-3 text-sm font-semibold hover:bg-[#008B87] transition"
                    >
