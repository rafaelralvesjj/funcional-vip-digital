      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            disabled={loading}
            className="inline-flex rounded-xl border border-[#00A19C]/30 bg-[#00A19C]/10 px-4 py-3 text-sm font-semibold text-[#00A19C] disabled:opacity-50"
          >
            Atualizar
          </button>
        </div>
          ...
          <>
            ...
            <div className="rounded-xl border border-[#00A19C]/20 bg-[#00A19C]/10 p-4">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                <div>
                  <p className="text-sm font-semibold text-[#00A19C]">Leitura executiva</p>
                ...
                <div className="flex flex-wrap gap-2 shrink-0">
                  ...
                  <button
                    ...
                    className="rounded-lg bg-[#00A19C] px-3 py-2 text-xs font-semibold text-[#0a0a0a]"
                  >
                    Baixar .txt
                  </button>
                </div>
              ...
              {pausesToShow.map((event) => (
                <div key={event.id} className="rounded-xl border border-[#ffffff10] bg-[#1a1a1a] p-4 space-y-3">
                  ...
                  <div className="rounded-lg border border-[#ffffff10] bg-[#0a0a0a] p-3">
                    <p className="text-[10px] font-semibold text-[#00A19C]">Ação recomendada</p>
                  ...
                  {event.description && (
                    <p className="text-xs leading-relaxed text-[#a1a1a1]">
                      <span className="text-[#00A19C] font-semibold">Relato:</span> {event.description}
                    </p>
                  )}
                </div>
              ))}
          ...
          <div className="space-y-2">
            {data.lifecycleEvents.map((event) => (
              <div key={event.id} className="rounded-xl border border-[#ffffff10] bg-[#1a1a1a] p-3 text-xs text-[#e5e5e5]">
                <p className="font-semibold text-[#00A19C]">{humanizeKey(event.eventType)}</p>
        ...
        {items.length === 0 ? (
          ...
          items.slice(0, 6).map(([key, value]) => (
            <div key={key} className="flex items-center justify-between gap-3 text-xs">
              ...
              <span className="rounded-full bg-[#0a0a0a] px-2 py-1 font-semibold text-[#00A19C]">{value}</span>
            </div>
          ))
        )}
      </div>
