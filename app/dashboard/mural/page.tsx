  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        <h1 className="text-xl font-bold text-[#00A19C]">Mural de Avisos</h1>

        <form
          onSubmit={handleSubmit}
          className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5 space-y-4"
        >
          <h2 className="text-lg font-semibold text-[#00A19C]">
            Publicar novo aviso
          </h2>
          ...
          <div>
            ...
            <textarea
              ...
              required
              className="w-full rounded-lg border border-[#ffffff10] bg-[#0a0a0a] px-4 py-3 text-sm text-[#f5f5f5] placeholder-[#6b6b6b] outline-none focus:border-[#00A19C] resize-none"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-[#ffffff10] bg-[#0a0a0a] px-4 py-3 text-sm text-[#f5f5f5] outline-none focus:border-[#00A19C] [color-scheme:dark]"
              />
          ...
          <button
            ...
            className="w-full bg-[#00A19C] text-[#0a0a0a] font-bold rounded-xl py-3 text-sm transition hover:bg-[#007D79] disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="bg-[#111111] border border-[#ffffff10] rounded-xl p-5">
          <h2 className="text-lg font-semibold text-[#00A19C] mb-4">
            Avisos publicados
          </h2>
                      ...
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-3 mt-2 text-[11px] text-[#6b6b6b]">
                            ...
                            <span className="bg-[#00A19C]/10 text-[#00A19C] px-2 py-0.5 rounded text-[10px]">
                              {notice.type}
                            </span>
        ...
        >
          ...
          >
            ...
            <input
              ...
              className="w-full bg-[#0a0a0a] text-white border border-[#2a2a2a] rounded px-3 py-2 text-sm mb-3 outline-none focus:border-[#00A19C]"
            />
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-[#0a0a0a] text-white border border-[#2a2a2a] rounded px-3 py-2 text-sm mb-4 outline-none focus:border-[#00A19C] resize-none"
            />
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                onClick={saveNotice}
                className="text-xs bg-[#00A19C] hover:bg-[#008B87] text-black px-4 py-1.5 rounded transition-colors"
              >
                Salvar
              </button>
            </div>
