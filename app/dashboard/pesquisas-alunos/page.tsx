      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
          <div className="rounded-2xl border border-[#ffffff10] bg-[#111111] p-4">
            ...
            <p className="mt-1 text-2xl font-bold text-[#D4A373]">{counts.total}</p>
          </div>
          <div className="rounded-2xl border border-[#ffffff10] bg-[#111111] p-4">
                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className="rounded-full border border-[#D4A373]/20 bg-[#D4A373]/10 px-2 py-1 text-[10px] font-semibold text-[#D4A373]">
                        {survey.surveyLabel}
                      </span>
                    </div>
                    ...
                    <p className="text-xs text-[#a1a1a1]">
                      Professor: <span className="text-[#D4A373]">{survey.professor?.name || "Não vinculado"}</span>
                    </p>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center rounded-lg border border-[#D4A373]/30 bg-[#D4A373]/10 px-3 py-2 text-xs font-semibold text-[#D4A373] hover:bg-[#D4A373]/20"
                  >
                    Ver ficha
                  </Link>
                </div>
                ...
                {(survey.favoritePoint || survey.mainDifficulty || survey.improvementSuggestion || survey.openFeedback) && (
                  <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
                    {survey.favoritePoint && (
                      <div className="rounded-xl border border-[#ffffff10] bg-[#0a0a0a] p-3">
                        <p className="text-[10px] font-semibold uppercase text-[#D4A373]">Gostou</p>
